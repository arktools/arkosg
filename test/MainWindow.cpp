...
MainWindow::MainWindow() : sceneRoot(new osg::Group), simThread(this)
{
    ...
    sceneRoot->addChild(new arkosg::Terrain(std::string(ARKOSG_INSTALL_DATA_DIR)+"/images/lz.rgb",osg::Vec3d(100,100,100)));
    ...
    try
    {
        plane = new arkosg::Plane(std::string(ARKOSG_INSTALL_DATA_DIR)+std::string("/models/plane.ac"));
